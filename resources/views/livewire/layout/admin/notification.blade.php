<div class="flex items-center">
    <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
        class="relative inline-flex items-center font-medium text-center bg-gray-100 rounded-full hover:bg-gray-200 h-8 w-8 text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400"
        type="button">
        <i class="bi bi-bell m-auto text-lg"></i>
    </button>

    <!-- Dropdown menu -->
    <div id="dropdownNotification"
        class="z-20 me-10 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow-none border dark:bg-gray-800 dark:divide-gray-700"
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-700">
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <div class="w-full ps-3">
                    <div class="text-gray-500 mb-1.5 dark:text-gray-400">New message from <span
            ...
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <div class="w-full ps-3">
                    <div class="text-gray-500 mb-1.5 dark:text-gray-400"><span
            ...
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <div class="w-full ps-3">
                    <div class="text-gray-500 mb-1.5 dark:text-gray-400"><span
                            ...
                            class="font-medium text-gray-900 dark:text-white">141 others</span> love your story. See it
            ...
            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <div class="w-full ps-3">
                    <div class="text-gray-500 mb-1.5 dark:text-gray-400"><span
                        ...
                        in a comment: <span class="font-medium text-blue-500" href="#">@bonnie.green</span> what
                        do you say?</div>
        ...
        <a href="#"
            class="block py-2 font-medium text-center text-gray-900 rounded-b-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white">
